    ...
    <>
      <div className="flex gap-2">
        ...
        <div className="relative">
          ...
          {copied && (
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1.5 bg-[#1A1A1A] border border-white/10 rounded-xl text-xs text-white/80 whitespace-nowrap shadow-lg pointer-events-none z-20">
              Link copied ✓
            </div>
          )}
        </div>
      ...
      {showSettings && (
        ...
        >
          <div className="w-full max-w-sm bg-[#111111] rounded-3xl border border-white/10 p-6 space-y-4">
