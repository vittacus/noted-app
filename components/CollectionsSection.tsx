    ...
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-[#117ACA] font-semibold hover:opacity-80 transition-opacity"
        >
          <Plus size={14} /> New
        </button>
      </div>
      ...
      {showInput && (
        <div className="flex gap-2 mb-3">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-[#117ACA]/20 text-[#117ACA] text-sm font-semibold hover:bg-[#117ACA]/30 transition-colors disabled:opacity-40"
          >
            {creating ? "…" : "Create"}
          </button>
        </div>
      ...
      <div className="space-y-2">
        {collections.map((col) => (
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#117ACA]/10 border border-[#117ACA]/20 flex items-center justify-center shrink-0">
              <FolderOpen size={18} className="text-[#117ACA]" />
            </div>
