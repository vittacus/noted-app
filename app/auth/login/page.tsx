  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center page-enter">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="bg-[#111111] rounded-3xl border border-white/8 p-6 space-y-4">
        ...
        <p className="text-center text-sm text-white/50 mt-5">
          ...
          <Link href="/auth/signup" className="text-[#F5A623] font-semibold hover:underline">
            Sign up
          </Link>
        </p>
      </div>
