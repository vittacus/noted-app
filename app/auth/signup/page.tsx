  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center page-enter">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSignup} className="bg-[#1e2d3d] rounded-3xl border border-white/5 p-6 space-y-4">
        ...
        <p className="text-center text-sm text-slate-500 mt-5">
          ...
          <Link href="/auth/login" className="text-[#4fc3f7] font-semibold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
