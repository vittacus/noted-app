      ...
      <div className="md:grid md:grid-cols-[300px_1fr] md:gap-8 md:items-start">
        ...
        <div className="mb-8 md:mb-0">
          ...
          <div className="flex flex-col items-center md:items-start mb-5">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#F64568] to-[#1a1a1a] flex items-center justify-center text-white text-3xl font-black mb-3 overflow-hidden shadow-xl shadow-[#F64568]/20">
              {profile?.avatar_url
