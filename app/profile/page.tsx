...
export default async function ProfilePage() {
  ...
  return (
    <div className="page-enter">
      <div className="bg-[#1a1a24] rounded-3xl p-5 border border-white/5 mb-4">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-white text-2xl font-black overflow-hidden">
            {profile?.avatar_url ? (
        ...
        <div className="mb-4">
          ...
          <div className="space-y-2">
            {top5.map((r: any, i: number) => (
              <div key={r.id} className="flex items-center gap-3 bg-[#1a1a24] rounded-2xl p-3 border border-white/5">
