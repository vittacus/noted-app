  ...
  return (
    <div className="page-enter">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          onClick={openPicker}
          className="w-9 h-9 rounded-full bg-[#4fa8ff]/10 border border-[#4fa8ff]/20 flex items-center justify-center hover:bg-[#4fa8ff]/20 transition-colors shrink-0"
        >
      ...
      {filteredSongs.length === 0 && songs.length > 0 && (
        <div className="text-center py-10">
          <p className="font-medium text-[#8686AC]">No {moodName} songs rated {scoreFilter}</p>
          <button onClick={() => setScoreFilter("all")} className="text-[#4fa8ff] text-xs font-semibold mt-2 hover:underline">Show all →</button>
        </div>
      )}
          ...
          <div className="relative w-full bg-[#1A1A4E] rounded-t-3xl flex flex-col"
            ...
            <div className="flex-1 overflow-y-auto px-5 py-3 space-y-2 min-h-0">
              ...
              {!pickerLoading && pickerSongs.length === 0 && (
                <p className="text-center text-[#8686AC]/75 text-sm py-10">
